              ...
              <div className="column">
                <div className="card">
                  <div className="card-body">
                    ...
                    <Link to={privateLinks.EditUser} className="nav-button">Edit Info</Link>
                  </div>
                </div>
              </div>
              ...
              <div className="column">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Total Units: <strong>{units.count}</strong><br></br>
                      Units allocated by the admin
                    </p>
                    <Link to="/units" className="nav-button">View Units</Link>
                  </div>
                </div>
              </div>
              ...
              <div className="column">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Students taking your units: <strong>{students.count}</strong><br></br>
                      Already registered to take the unit
                    </p>
                    <Link to="/students" className="nav-button">View Students</Link>
                  </div>
                </div>
              </div>
            </div>
